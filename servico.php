						...
						<div class="max-w-screen-md mx-auto">
							<div id="accordion-flush" data-accordion="collapse" data-active-classes="text-gray-900" data-inactive-classes="text-gray-500">
								<h3 id="accordion-flush-heading-11">
									<button type="button" class="flex items-center justify-between w-full py-5 font-bold text-left text-gray-800 border-b border-gray-200" data-accordion-target="#accordion-flush-body-11" aria-expanded="true" aria-controls="accordion-flush-body-11">
								...
								<div id="accordion-flush-body-11" class="" aria-labelledby="accordion-flush-heading-11">
									<div class="py-5 border-b border-gray-200">
										<p class="mb-2 ">As taxas do cartão consignado variam de acordo com a instituição financeira que oferece o serviço, mas geralmente são menores do que as cobradas nos cartões de crédito convencionais.
										</p>
									</div>
								</div>
