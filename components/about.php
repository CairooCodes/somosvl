<div class="mx-auto max-w-6xl pt-2 about">
  ...
  <div class="pt-10 form">
		<div class="lg:w-2/3 pt-20 px-4 pb-8 mx-auto lg:pb-16">
			<div class="swiper-slide shadow-inner bg-color2 bg-opacity-70 shadow-md rounded-xl border border-gray-300">
				<div class="max-w-screen-xl px-4 pt-8 mx-auto mb-3 text-center">
					<h1 class="mt-5 text-gray-600 font-semibold lg:text-3xl text-xl">Nossas ofertas podem chegar primeiro para você</h1>
				</div>
