...
{
    global $DB_con;
    $stmt = $DB_con->prepare("SELECT * FROM categories WHERE id = :id");
...
<head>
    <title>Dashboard Miraceu Digital</title>
    <meta charset="UTF-8">
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        ...
        <div class="max-w-7xl px-4 pb-8 mx-auto py-8">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <form action="./controllers/edit_categorie.php?id=<?php echo $categorie['id']; ?>" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow">
                    <!-- Modal header -->
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input name="name" type="text" value="<?php echo $categorie['name']; ?>" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nome do Produto" required="">
                            </div>
