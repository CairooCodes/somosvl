  ...
  <div class="pt-10 md:pt-0 md:px-0 px-4 relative min-h-screen sm:flex sm:flex-col justify-center bg-transparent rounded-3xl">
    <div class="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
      <div class="flex justify-center text-gray-300">
        <img src="../assets/img/logo.png" class="w-32">
      </div>
    </div>
      ...
      <div class="p-12 bg-white mx-auto rounded-2xl w-96 ">
        ...
        <form action="./controllers/auth.php" method="POST">
          <div class="space-y-6">
            ...
            <div>
              <button type="submit" class="w-full flex justify-center bg-purple-300  hover:bg-purple-500 text-black p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
                Entrar
              </button>
            </div>
          </div>
