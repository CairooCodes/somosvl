...
<head>
  <title>Banners Somos VL - Consultoria e Negócios</title>
  <meta charset="UTF-8">
            ...
            ?>
              <tr class="bg-white border-b">
                ...
                <td class="px-6 py-4">
                  ...
                  <a href="./editar_banner.php?id=<?php echo $banners['id']; ?>" type="button" data-modal-target="editUserModal" data-modal-show="editUserModal" class="font-medium text-blue-600 hover:underline">Editar</a>
