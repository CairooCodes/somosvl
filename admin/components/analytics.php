<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
  <div class="md:col-span-2 lg:col-span-1">
    <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
      ...
      <div>
        <h5 class="text-xl text-gray-600 text-center">Dispositivos</h5>
        <div class="mt-2 flex justify-center gap-4">
        </div>
        <span class="block text-center text-gray-500">Dispositivos que geram os melhores resultados?</span>
      </div>
      <table class="w-full text-gray-600">
        <tbody>
          <tr>
            <td class="py-2">Celular</td>
  ...
  <div>
    <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
      <h5 class="text-xl text-gray-700">Visualizações de página</h5>
      <div class="my-8">
        <span class="text-gray-500">Páginas seus usuários visitam</span>
      </div>
      <svg class="w-full" viewBox="0 0 218 69" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <linearGradient id="paint0_linear_622:13664" x1="218" y1="18.3748" x2="5.4362" y2="18.9795" gradientUnits="userSpaceOnUse">
            <stop stop-color="#4DFFDF" />
            <stop offset="1" stop-color="#4DA1FF" />
          </linearGradient>
      ...
      <table class="mt-6 -mb-2 w-full text-gray-600">
        <tbody>
          <tr>
            <td class="py-2">Página Inicial</td>
            <td class="text-gray-500">0</td>
            <td>
              <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
          ...
          <tr>
            <td class="py-2">Licitações Sustentáveis na Nova Lei de Licitações</td>
            <td class="text-gray-500">0</td>
            <td>
              <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
  ...
  <div>
    <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
      ...
      <div class="mt-6">
        <h5 class="text-xl text-gray-700 text-center">Leads</h5>
        <div class="mt-2 flex justify-center gap-4">
        ...
        <span class="block text-center text-gray-500">Últimos 30 dias leads</span>
      </div>
      <table class="mt-6 -mb-2 w-full text-gray-600">
        <tbody>
          <tr>
