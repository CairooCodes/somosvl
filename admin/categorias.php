              ...
              <tbody>
                <?php foreach ($categories as $categorie) { ?>
                  <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4">
                    <a href="./editar_categoria.php?id=<?php echo $categorie['id']; ?>" type="button" data-modal-target="editUserModal" data-modal-show="editUserModal" class="font-medium text-blue-600 hover:underline">Editar</a>
